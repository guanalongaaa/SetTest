...
-(id)initWithTitle:(NSString *)inTitle message:(NSString *)inMessage cancelButtonItem:(GALButtonItem *)inCancelButtonItem otherButtonItems:(GALButtonItem *)inOtherButtonItems, ...
{
